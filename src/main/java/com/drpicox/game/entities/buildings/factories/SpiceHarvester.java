...
@Component
public class SpiceHarvester implements BuilderFactory {
    ...
    public SpiceHarvester(EntityIdGenerator entityIdGenerator, ContainedsController containedsController, NamedsController namedsController, TypedsController typedsController, ResourcedsController resourcedsController, ResourcedModifiersController resourcedModifiersController) {
    ...
    public String build(String containerId) {
        ...
        resourcedModifiersController.create(entityId, ResourceType.PEPPER, 1, 0);
        return entityId;
    }
}
